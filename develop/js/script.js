const api_key = 'c04ed60909d66b558fcb4c66996ce63a'; // API key used to retreive data
let url; 
const five_day = document.querySelector('#weather-cards');
const search = document.querySelector('#search');
const cityName = document.querySelector('#city');
const saveCity = document.querySelector('#save-city');
const navigate = document.querySelector('.navbar');
const week = ['Sun','Mon', 'Tue', 'Wed', 'Thur', 'Fri', 'Sat', 'Sun', 'Mon', 'Tue', 'Wed', 'Thur', 'Fri', 'Sat']; // array that contains the days of the week
let cityDefault = 'Mississauga';
let citySearch;
let searchedCity;
